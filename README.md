...
Paperclip is an experimental DSL for no-code UI builders that aims to be compatible with just about any kind of web application. Here's a basic example of what it looks like:
