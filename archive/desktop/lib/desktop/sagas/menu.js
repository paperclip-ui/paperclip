...
var shortcutKeyDown = tandem_common_1.publicActionCreator(function (type) { return ({
    type: type
}); });
function shortcutsSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.take(actions_1.MAIN_WINDOW_OPENED)];
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(handleMenu)];
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(handleFSItemContextMenuOptions)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
function handleFSItemContextMenuOptions() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeEvery("FILE_ITEM_CONTEXT_MENU_COPY_PATH_CLICKED", function (_a) {
                    var item = _a.item;
                    electron_1.clipboard.writeText(tandem_common_1.stripProtocol(item.uri));
                })];
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.takeEvery("FILE_ITEM_CONTEXT_MENU_OPEN_IN_FINDER_CLICKED", function (_a) {
                        var item = _a.item;
                        var path = tandem_common_1.stripProtocol(item.uri);
                    })];
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.takeEvery("FILE_ITEM_CONTEXT_MENU_OPEN_CLICKED", function (_a) {
                        var item = _a.item;
                        var path = tandem_common_1.stripProtocol(item.uri);
                        child_process_1.exec("open " + path.replace(/\s/g, "\\ "));
                    })];
            case 3:
                _a.sent();
                return [4 /*yield*/, effects_1.takeEvery("OPEN_TEXT_EDITOR_BUTTON_CLICKED", function (_a) {
                        var uri = _a.uri;
                        var path = tandem_common_1.stripProtocol(uri);
                        child_process_1.exec("open " + path.replace(/\s/g, "\\ "));
                    })];
            case 4:
                _a.sent();
...
var cmdKey = os_1.platform() === "win32" ? "ctrl" : "meta";
function handleMenu() {
