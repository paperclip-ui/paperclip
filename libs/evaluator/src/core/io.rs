...
impl<TReader: FileReader, TResolver: FileResolver> PCFileResolver<TReader, TResolver> {
  pub fn new(reader: TReader, resolver: TResolver, options: Option<PCFileResolverOptions>) -> Self {
    Self {
      reader,
      resolver,
...
impl<TReader: FileReader, TResolver: FileResolver> FileResolver for PCFileResolver<TReader, TResolver> {
