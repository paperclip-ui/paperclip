...
exports.imagePathPicked = (0, tandem_common_1.publicActionCreator)(function (filePath) { return ({
    filePath: filePath,
    type: exports.IMAGE_PATH_PICKED
}); });
exports.directoryPathPicked = (0, tandem_common_1.publicActionCreator)(function (directoryPath) { return ({
    directoryPath: directoryPath,
    type: exports.DIRECTORY_PATH_PICKED
}); });
var appReady = function () { return ({ type: exports.APP_READY }); };
exports.appReady = appReady;
var tdProjectFilePicked = function (filePath) { return ({
    filePath: filePath,
    type: exports.TD_PROJECT_FILE_PICKED
}); };
exports.tdProjectFilePicked = tdProjectFilePicked;
var localFileOpened = function (path) { return ({
    type: exports.LOCAL_FILE_LOADED,
    path: path
}); };
exports.localFileOpened = localFileOpened;
exports.componentControllerPicked = (0, tandem_common_1.publicActionCreator)(function (filePath) { return ({
    filePath: filePath,
    type: "COMPONENT_CONTROLLER_PICKED"
}); });
var mainWindowOpened = function () { return ({ type: exports.MAIN_WINDOW_OPENED }); };
exports.mainWindowOpened = mainWindowOpened;
exports.tdProjectLoaded = (0, tandem_common_1.publicActionCreator)(function (project, path) { return ({
    type: exports.TD_PROJECT_LOADED,
    project: project,
    path: path
}); });
var previewServerStarted = function (port) { return ({
    type: exports.PREVIEW_SERVER_STARTED,
    port: port
}); };
exports.previewServerStarted = previewServerStarted;
