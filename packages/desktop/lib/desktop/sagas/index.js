...
var createDefaultTDProjectFiles = function () {
    var _a;
    return ({
        "./src/main.pc": JSON.stringify((0, paperclip_1.createPCModule)([
            (0, paperclip_1.createPCComponent)("Application", null, null, null, [(0, paperclip_1.createPCTextNode)("App content")], (_a = {},
...
function rootSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            return [4 /*yield*/, (0, effects_1.fork)(openMainWindow)];
            case 1:
                // yield fork(watchProjectDirectory);
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(electron_1.electronSaga)];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(ipc_1.ipcSaga)];
            case 3:
                _a.sent();
                // yield fork(handleLoadProject);
                return [4 /*yield*/, (0, effects_1.fork)(menu_1.shortcutsSaga)];
            case 4:
                // yield fork(handleLoadProject);
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleBrowseDirectory)];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(previewServer)];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleOpenProject)];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleCreateProject)];
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(initProjectDirectory)];
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleOpenedWorkspaceDirectory)];
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleAddControllerClick)];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleBrowseImage)];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleChrome)];
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleOpenedLocalFile)];
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(watchProjectFilePath)];
            case 15:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, effects_1.call)(loadTDConfig)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.tdProjectLoaded)(project, state.tdProjectPath))];
            case 2:
                // TODO - validate config here
                _a.sent();
                return [2 /*return*/];
            ...
            case 0:
                _loop_1 = function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, (0, effects_1.take)(actions_1.TD_PROJECT_LOADED)];
                            case 1:
                                _b.sent();
...
function openMainWindow() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, effects_1.take)(actions_1.APP_READY)];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.select)()];
            case 2:
                ...
                if (state.info.previewServer) {
                    query.previewHost = "localhost:".concat(state.info.previewServer.port);
                }
                if (!withFrame) {
                ...
                return [4 /*yield*/, (0, effects_1.fork)(function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    message = _a.sent();
                                    if ((0, tandem_common_1.isPublicAction)(message) && !message["@@" + ipc_1.pid]) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.mainWindowOpened)())];
            case 4:
                _a.sent();
                return [2 /*return*/];
        }
...
function handleOpenProject() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!1) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, effects_1.take)([actions_1.OPEN_PROJECT_MENU_ITEM_CLICKED, "OPEN_PROJECT_BUTTON_CLICKED"])];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.call)(electron_2.dialog.showOpenDialog, {
                        filters: [
                            {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.tdProjectFilePicked)((0, tandem_common_1.normalizeFilePath)(filePath)))];
            case 3:
                _a.sent();
                return [3 /*break*/, 0];
            case 4: return [2 /*return*/];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.tdProjectFilePicked)(filePath))];
            case 2:
                _b.sent();
                return [3 /*break*/, 0];
            case 3: return [2 /*return*/];
...
function handleChrome() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, effects_1.fork)(function handleCloseClick() {
                    var _a, unsaved, origin_1, sender, option;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                if (!1) return [3 /*break*/, 6];
                                return [4 /*yield*/, (0, effects_1.take)("CHROME_CLOSE_BUTTON_CLICKED")];
                            case 1:
                            ...
                            case 2:
                                _b.sent();
                                return [3 /*break*/, 0];
                            case 3: return [4 /*yield*/, (0, effects_1.call)(electron_2.dialog.showMessageBox, {
...
function handleOpenedWorkspaceDirectory() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!1) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, effects_1.take)([actions_1.TD_PROJECT_FILE_PICKED, actions_1.LOCAL_FILE_LOADED])];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.call)(initProjectDirectory)];
            case 2:
                _a.sent();
                return [3 /*break*/, 0];
            case 3: return [2 /*return*/];
...
function handleAddControllerClick() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!1) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, effects_1.take)("ADD_COMPONENT_CONTROLLER_BUTTON_CLICKED")];
            case 1:
            ...
            case 2:
                controllerFilePath = (_a.sent())[0];
                if (!controllerFilePath) {
                    return [3 /*break*/, 0];
                }
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.componentControllerPicked)((0, tandem_common_1.normalizeFilePath)(controllerFilePath)))];
            case 3:
                _a.sent();
                return [3 /*break*/, 0];
            case 4: return [2 /*return*/];
...
function handleBrowseImage() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!1) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, effects_1.take)(["IMAGE_BROWSE_BUTTON_CLICKED"])];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.call)(electron_2.dialog.showOpenDialog, {
                        filters: [
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.imagePathPicked)((0, tandem_common_1.normalizeFilePath)(filePath)))];
            case 3:
                _a.sent();
                return [3 /*break*/, 0];
            case 4: return [2 /*return*/];
...
function handleBrowseDirectory() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!1) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, effects_1.take)(["BROWSE_DIRECTORY_CLICKED"])];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.call)(electron_2.dialog.showOpenDialog, {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, effects_1.put)((0, actions_1.directoryPathPicked)((0, tandem_common_1.normalizeFilePath)(directory)))];
            case 3:
                _a.sent();
                return [3 /*break*/, 0];
            case 4: return [2 /*return*/];
