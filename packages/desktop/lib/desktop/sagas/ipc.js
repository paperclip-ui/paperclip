...
function ipcSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, effects_1.fork)(actionSaga)];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(apiSaga)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _loop_1 = function () {
                    var _b, message, event_1;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, (0, effects_1.take)(chan)];
                            case 1:
                                _b = _c.sent(), message = _b.arg, event_1 = _b.event;
                                message["@@" + exports.pid] = true;
                                console.log("incomming IPC message:", message);
                                return [4 /*yield*/, (0, effects_1.spawn)(function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, (0, effects_1.put)(__assign(__assign({}, message), { origin: event_1 }))];
                                                case 1:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
...
function apiSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, effects_1.fork)(function getProjectInfo() {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(function openDialog() {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(function openContextMenu() {
                        var chan, _loop_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    _loop_2 = function () {
                                        var _b, event_4, _c, point, options, menuChan, action;
                                        return __generator(this, function (_d) {
                                            switch (_d.label) {
                                                case 0: return [4 /*yield*/, (0, effects_1.take)(chan)];
                                                case 1:
                                                    _b = _d.sent(), event_4 = _b.event, _c = _b.arg, point = _c.point, options = _c.options;
                                                    menuChan = (0, redux_saga_1.eventChannel)(function (emit) {
                                                    ...
                                                    return [4 /*yield*/, (0, effects_1.take)(menuChan)];
                                                case 2:
                                                    action = _d.sent();
...
var generateMenuTpl = function (options, click) {
    return options.reduce(function (items, option, i) {
        if (option.type === "group") {
            items = __spreadArray(__spreadArray([], items, true), generateMenuTpl(option.options, click), true);
...
var takeIPCEvents = function (eventType) {
    return (0, redux_saga_1.eventChannel)(function (emit) {
