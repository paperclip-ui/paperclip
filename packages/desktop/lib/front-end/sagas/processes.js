...
function processSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, effects_1.fork)(handleStartBuild)];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.fork)(handleOpenApp)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, effects_1.take)([tandem_front_end_1.BUILD_BUTTON_START_CLICKED])];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.call)(startBuild)];
            case 2:
                _a.sent();
                return [3 /*break*/, 0];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, effects_1.take)(tandem_front_end_1.BUILD_BUTTON_OPEN_APP_CLICKED)];
            case 1:
                _a.sent();
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, effects_1.call)(spawnScript, openAppScript, "Open App", path.dirname((0, tandem_common_1.stripProtocol)(state.projectInfo.path)))];
            case 3:
                _a.sent();
                return [3 /*break*/, 0];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, effects_1.call)(spawnScript, buildScript, "Build", path.dirname((0, tandem_common_1.stripProtocol)(state.projectInfo.path)))];
            case 2:
                scriptProcess = _a.sent();
                // check if process has been removed from state
                return [4 /*yield*/, (0, effects_1.fork)(function handleScriptChanged() {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, (0, redux_saga_1.delay)(0)];
                                case 2:
                                    // slight pause to ensure that reducer is called first
                                    _a.sent();
            ...
            case 3:
                // check if process has been removed from state
                _a.sent();
                return [4 /*yield*/, (0, effects_1.put)((0, tandem_front_end_1.buildScriptStarted)(scriptProcess))];
            case 4:
                _a.sent();
                return [2 /*return*/];
        }
...
function spawnScript(script, label, cwd) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                scriptProcess = (0, tandem_front_end_1.createScriptProcess)(label, script);
                return [4 /*yield*/, (0, effects_1.put)((0, tandem_front_end_1.scriptProcessStarted)(scriptProcess))];
            case 1:
                _a.sent();
                            ...
                            switch (_a.label) {
                                case 0:
                                    channel = (0, redux_saga_1.eventChannel)(function (emit) {
                                        ...
                                        var proc = (0, child_process_1.spawn)(script, [], {
                                            shell: true,
                                            cwd: cwd
                                        });
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        unloader = (0, tandem_front_end_1.createUnloader)();
                                                        return [4 /*yield*/, (0, effects_1.put)((0, tandem_front_end_1.unloaderCreated)(unloader))];
                                                    case 3:
                                                        _a.sent();
                                                        channel.close();
                                                        // give some time for async terminator to work. Could
                                                        // cause race conditions. 🙈
                                                        return [4 /*yield*/, (0, effects_1.call)(redux_saga_1.delay, UNLOADER_TIMEOUT)];
                                                    case 4:
                                                        // give some time for async terminator to work. Could
                                                        // cause race conditions. 🙈
                                                        _a.sent();
                                                        return [4 /*yield*/, (0, effects_1.put)((0, tandem_front_end_1.unloaderCompleted)(unloader))];
                                                    case 5:
                                                        _a.sent();
                                                        return [3 /*break*/, 7];
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, (0, effects_1.put)((0, tandem_front_end_1.scriptProcessStopped)(scriptProcess))];
                                case 4:
                                    _a.sent();
                                    return [3 /*break*/, 10];
                                case 5:
                                    if (!(event_1.type === "stdout")) return [3 /*break*/, 7];
                                    return [4 /*yield*/, (0, effects_1.put)((0, tandem_front_end_1.scriptProcessLog)(scriptProcess, {
