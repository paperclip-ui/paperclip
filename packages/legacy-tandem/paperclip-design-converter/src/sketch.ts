...
const mapStyle = (layer: any) => {
  ...
  if (fixedRadius) {
    convertedStyle["border-top-left-radius"] =
      convertedStyle["border-bottom-left-radius"] =
      convertedStyle["border-top-right-radius"] =
      convertedStyle["border-bottom-right-radius"] =
        `${fixedRadius}px`;
  }
