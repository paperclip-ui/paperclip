...
} & BaseTreeNodeOperationalTransform<TreeNodeOperationalTransformType.INSERT_CHILD>;

export type RemoveChildNodeOperationalTransform = {
  nodePath: number[];
  index: number;
} & BaseTreeNodeOperationalTransform<TreeNodeOperationalTransformType.REMOVE_CHILD>;

export type MoveChildNodeOperationalTransform = {
  nodePath: number[];
  oldIndex: number;
  newIndex: number;
} & BaseTreeNodeOperationalTransform<TreeNodeOperationalTransformType.MOVE_CHILD>;

export type SetNodePropertyOperationalTransform = {
  nodePath: number[];
  name: string;
  value: any;
} & BaseTreeNodeOperationalTransform<TreeNodeOperationalTransformType.SET_PROPERTY>;
