        ...
        switch (_a.label) {
          case 0:
            defaultFilePath = path.join(
              cwd,
              constants_1.DEFAULT_PROJECT_FILE_NAME
            );
            if (fs.existsSync(defaultFilePath)) {
              console.warn(
                chalk_1.default.yellow(
                  "A Tandem project already exists in this directory."
                )
              );
              return [2 /*return*/];
            }
          ...
          case 1:
            ...
            console.log(
              "Config docs for "
                .concat(path.basename(defaultFilePath), " can be found at ")
                .concat(
            ...
            console.log("");
            console.log(
              chalk_1.default.white.bold("You can now run"),
              chalk_1.default.bold.blue("tandem open")
            );
            console.log("");
            return [2 /*return*/];
        }
...
var pickProjectFilePath = function (cwd) {
  return __awaiter(void 0, void 0, void 0, function () {
    var defaultFilePath;
    return __generator(this, function (_a) {
