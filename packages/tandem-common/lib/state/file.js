...
exports.sortFSItems =
  exports.updateFSItemAlts =
  exports.mergeFSItems =
  exports.convertFlatFilesToNested2 =
  exports.convertFlatFilesToNested =
  exports.getFilesWithExtension =
  exports.getFileFromUri =
  exports.getFilePathFromNodePath =
  exports.getFilePath =
  exports.createDirectory =
  exports.createFile =
  exports.isDirectory =
  exports.isFile =
  exports.FileAttributeNames =
  exports.FSItemTagNames =
  exports.FSItemNamespaces =
    void 0;
...
(function (FSItemNamespaces) {
  ...
  (FSItemNamespaces =
    exports.FSItemNamespaces || (exports.FSItemNamespaces = {}))
);
var FSItemTagNames;
...
(function (FileAttributeNames) {
  ...
  (FileAttributeNames =
    exports.FileAttributeNames || (exports.FileAttributeNames = {}))
);
...
var getFileName = function (current) {
  return path.basename(current.uri);
};
...
var getFilePathFromNodePath = function (path, directory) {
  return (0, exports.getFilePath)(
    (0, tree_1.getTreeNodeFromPath)(path, directory),
    directory
  );
};
exports.getFilePathFromNodePath = getFilePathFromNodePath;
var getFileFromUri = function (uri, root) {
  return (0, tree_1.findNestedNode)(root, function (child) {
    return child.uri === uri;
  });
};
exports.getFileFromUri = getFileFromUri;
exports.getFilesWithExtension = (0, memoization_1.memoize)(function (
  extension,
  directory
) {
  var tester = new RegExp("".concat(extension, "$"));
  return (0, tree_1.filterNestedNodes)(directory, function (file) {
    return (0, exports.isFile)(file) && tester.test(getFileName(file));
  });
});
var convertFlatFilesToNested = function (files) {
  ...
  var highestDirname;
  for (
    var _i = 0, sortedFiles_1 = sortedFiles;
    _i < sortedFiles_1.length;
    _i++
  ) {
    var _a = sortedFiles_1[_i],
      filePath = _a[0],
      isDirectory_1 = _a[1];
    var uri = (0, protocol_1.addProtocol)(protocol_1.FILE_PROTOCOL, filePath);
    if (isDirectory_1) {
      highest = (0, exports.createDirectory)(
        uri,
        (0, exports.sortFSItems)(pool[uri] || __1.EMPTY_ARRAY)
      );
    } else {
...
var convertFlatFilesToNested2 = function (items) {
  ...
  var highestDirname;
  for (
    var _i = 0, sortedFiles_2 = sortedFiles;
    _i < sortedFiles_2.length;
    _i++
  ) {
    var _a = sortedFiles_2[_i],
      filePath = _a[0],
      isDirectory_2 = _a[1];
    var uri = (0, protocol_1.addProtocol)(protocol_1.FILE_PROTOCOL, filePath);
    if (isDirectory_2) {
  ...
  return (0, exports.updateFSItemAlts)(
    highestPool.length === 1 && highestPool[0].name === FSItemTagNames.DIRECTORY
      ? highestPool[0]
      : (0, exports.createDirectory)(
          highestDirname,
          (0, exports.sortFSItems)(highestPool),
          true
        )
  );
};
...
var mergeFSItems = function () {
  ...
  var flattenedItems = (0, lodash_1.uniqBy)(
    items.reduce(function (allItems, item) {
      return __spreadArray(
        __spreadArray([], allItems, true),
        (0, tree_1.flattenTreeNode)(item),
        true
      );
    }, __1.EMPTY_ARRAY),
    function (item) {
  ...
  var itemMap = {};
  for (
    var _a = 0, flattenedItems_1 = flattenedItems;
    _a < flattenedItems_1.length;
    _a++
  ) {
  ...
  var mapTree = function (node) {
    ...
    if (node.name === FSItemTagNames.DIRECTORY) {
      return __assign(__assign(__assign({}, node), existing), {
  ...
  return (0, exports.updateFSItemAlts)(
    mapTree((0, exports.convertFlatFilesToNested2)(flattenedItems))
  );
};
...
var updateFSItemAlts = function (root) {
  var flattened = (0, tree_1.flattenTreeNode)(root).filter(function (node) {
    return (
      (0, tree_1.getParentTreeNode)(node.id, root) &&
